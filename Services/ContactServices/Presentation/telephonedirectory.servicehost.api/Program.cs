...
using telephonedirectory.application;  
using Microsoft.EntityFrameworkCore;
using Microsoft.IdentityModel.Tokens;
using Microsoft.OpenApi.Models;
using System.Reflection;
using System.Text;
using telephonedirectory.persistence;
using telephonedirectory.servicehost.api.OAuth;
using telephonedirectory.persistence.Context;
using telephonedirectory.application.Handlers.Persons.ValidationRules;
using telephonedirectory.infrastructure.Attributes;
using telephonedirectory.servicehost.api.Extensions;
